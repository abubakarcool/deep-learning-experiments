...
# Since our dataset contains text reviews, we need to clean and preprocess the text to prepare it for the model.
...
vectorizer_ngram = TfidfVectorizer(ngram_range=(1, 2), max_features=500)  ## Use bigrams and trigrams in CountVectorizer=> 1-grams, 2-grams, and 3-grams
